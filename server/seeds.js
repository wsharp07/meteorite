...
var vendorSeeds = [
  {
    ...
    slug: "martian-armaments",
    name: "Martian Armaments, Ltd",
    description: "Purveyor of fine astronmical bits of warfare"
  },
  {
    id: 2,
    slug: "red-planet",
    name: "Red Planet Love Machine",
    description: "Bringing you closer to the ones you love"
  },
  {
    id: 3,
    slug: "marinaris",
    name: "Marinaris Outfitters",
    description: "Get out and get git on Mars!"
  }
];
...
if(Meteor.users.find().count() === 0){
  _.each(userSeeds, function(user){
